...
interface CreateQuestionarioModalProps {
  ...
  onCreateQuestionario?: (questionario: any) => void
}

export function CreateQuestionarioModal({ children, onCreateQuestionario }: CreateQuestionarioModalProps) {
  ...
  const handleSubmit = () => {
    ...
    onCreateQuestionario?.(questionario)
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label>Tipo</Label>
              <Select value={type} onValueChange={(value: "individual" | "team") => setType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
